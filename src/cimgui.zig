...
pub const struct_ImGuiWindow = extern struct {
    Name: [*c]u8,
    ID: ImGuiID,
    ...
    ResizeBorderHeld: i8,
    BeginCount: c_short,
    BeginOrderWithinParent: c_short,
    BeginOrderWithinContext: c_short,
    PopupId: ImGuiID,
    AutoFitFramesX: ImS8,
    AutoFitFramesY: ImS8,
    ...
    HiddenFramesCanSkipItems: c_int,
    HiddenFramesCannotSkipItems: c_int,
...
pub const struct_ImGuiContext = extern struct {
    ...
    HoveredRootWindow: [*c]ImGuiWindow,
    ...
    NavWrapRequestWindow: [*c]ImGuiWindow,
    ...
    FocusRequestCurrWindow: [*c]ImGuiWindow,
    FocusRequestNextWindow: [*c]ImGuiWindow,
...
pub const struct_ImFontGlyph = opaque {}; // thirdparty/imgui/cimgui.h:968:18: warning: struct demoted to opaque type - has bitfield
...
pub const ImFileHandle = ?*std.c.FILE;
...
pub const ImGuiWindowFlags_None = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_None);
pub const ImGuiWindowFlags_NoTitleBar = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_NoTitleBar);
pub const ImGuiWindowFlags_NoResize = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_NoResize);
pub const ImGuiWindowFlags_NoMove = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_NoMove);
pub const ImGuiWindowFlags_NoScrollbar = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_NoScrollbar);
pub const ImGuiWindowFlags_NoScrollWithMouse = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_NoScrollWithMouse);
pub const ImGuiWindowFlags_NoCollapse = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_NoCollapse);
pub const ImGuiWindowFlags_AlwaysAutoResize = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_AlwaysAutoResize);
pub const ImGuiWindowFlags_NoBackground = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_NoBackground);
pub const ImGuiWindowFlags_NoSavedSettings = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_NoSavedSettings);
pub const ImGuiWindowFlags_NoMouseInputs = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_NoMouseInputs);
pub const ImGuiWindowFlags_MenuBar = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_MenuBar);
pub const ImGuiWindowFlags_HorizontalScrollbar = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_HorizontalScrollbar);
pub const ImGuiWindowFlags_NoFocusOnAppearing = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_NoFocusOnAppearing);
pub const ImGuiWindowFlags_NoBringToFrontOnFocus = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_NoBringToFrontOnFocus);
pub const ImGuiWindowFlags_AlwaysVerticalScrollbar = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_AlwaysVerticalScrollbar);
pub const ImGuiWindowFlags_AlwaysHorizontalScrollbar = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_AlwaysHorizontalScrollbar);
pub const ImGuiWindowFlags_AlwaysUseWindowPadding = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_AlwaysUseWindowPadding);
pub const ImGuiWindowFlags_NoNavInputs = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_NoNavInputs);
pub const ImGuiWindowFlags_NoNavFocus = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_NoNavFocus);
pub const ImGuiWindowFlags_UnsavedDocument = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_UnsavedDocument);
pub const ImGuiWindowFlags_NoNav = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_NoNav);
pub const ImGuiWindowFlags_NoDecoration = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_NoDecoration);
pub const ImGuiWindowFlags_NoInputs = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_NoInputs);
pub const ImGuiWindowFlags_NavFlattened = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_NavFlattened);
pub const ImGuiWindowFlags_ChildWindow = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_ChildWindow);
pub const ImGuiWindowFlags_Tooltip = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_Tooltip);
pub const ImGuiWindowFlags_Popup = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_Popup);
pub const ImGuiWindowFlags_Modal = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_Modal);
pub const ImGuiWindowFlags_ChildMenu = @enumToInt(enum_unnamed_6.ImGuiWindowFlags_ChildMenu);
...
pub const ImGuiWindowFlags_ = enum_unnamed_6;
pub const ImGuiInputTextFlags_None = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_None);
pub const ImGuiInputTextFlags_CharsDecimal = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_CharsDecimal);
pub const ImGuiInputTextFlags_CharsHexadecimal = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_CharsHexadecimal);
pub const ImGuiInputTextFlags_CharsUppercase = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_CharsUppercase);
pub const ImGuiInputTextFlags_CharsNoBlank = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_CharsNoBlank);
pub const ImGuiInputTextFlags_AutoSelectAll = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_AutoSelectAll);
pub const ImGuiInputTextFlags_EnterReturnsTrue = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_EnterReturnsTrue);
pub const ImGuiInputTextFlags_CallbackCompletion = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_CallbackCompletion);
pub const ImGuiInputTextFlags_CallbackHistory = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_CallbackHistory);
pub const ImGuiInputTextFlags_CallbackAlways = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_CallbackAlways);
pub const ImGuiInputTextFlags_CallbackCharFilter = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_CallbackCharFilter);
pub const ImGuiInputTextFlags_AllowTabInput = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_AllowTabInput);
pub const ImGuiInputTextFlags_CtrlEnterForNewLine = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_CtrlEnterForNewLine);
pub const ImGuiInputTextFlags_NoHorizontalScroll = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_NoHorizontalScroll);
pub const ImGuiInputTextFlags_AlwaysInsertMode = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_AlwaysInsertMode);
pub const ImGuiInputTextFlags_ReadOnly = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_ReadOnly);
pub const ImGuiInputTextFlags_Password = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_Password);
pub const ImGuiInputTextFlags_NoUndoRedo = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_NoUndoRedo);
pub const ImGuiInputTextFlags_CharsScientific = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_CharsScientific);
pub const ImGuiInputTextFlags_CallbackResize = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_CallbackResize);
pub const ImGuiInputTextFlags_CallbackEdit = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_CallbackEdit);
pub const ImGuiInputTextFlags_Multiline = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_Multiline);
pub const ImGuiInputTextFlags_NoMarkEdited = @enumToInt(enum_unnamed_7.ImGuiInputTextFlags_NoMarkEdited);
...
pub const ImGuiInputTextFlags_ = enum_unnamed_7;
pub const ImGuiTreeNodeFlags_None = @enumToInt(enum_unnamed_8.ImGuiTreeNodeFlags_None);
pub const ImGuiTreeNodeFlags_Selected = @enumToInt(enum_unnamed_8.ImGuiTreeNodeFlags_Selected);
pub const ImGuiTreeNodeFlags_Framed = @enumToInt(enum_unnamed_8.ImGuiTreeNodeFlags_Framed);
pub const ImGuiTreeNodeFlags_AllowItemOverlap = @enumToInt(enum_unnamed_8.ImGuiTreeNodeFlags_AllowItemOverlap);
pub const ImGuiTreeNodeFlags_NoTreePushOnOpen = @enumToInt(enum_unnamed_8.ImGuiTreeNodeFlags_NoTreePushOnOpen);
pub const ImGuiTreeNodeFlags_NoAutoOpenOnLog = @enumToInt(enum_unnamed_8.ImGuiTreeNodeFlags_NoAutoOpenOnLog);
pub const ImGuiTreeNodeFlags_DefaultOpen = @enumToInt(enum_unnamed_8.ImGuiTreeNodeFlags_DefaultOpen);
pub const ImGuiTreeNodeFlags_OpenOnDoubleClick = @enumToInt(enum_unnamed_8.ImGuiTreeNodeFlags_OpenOnDoubleClick);
pub const ImGuiTreeNodeFlags_OpenOnArrow = @enumToInt(enum_unnamed_8.ImGuiTreeNodeFlags_OpenOnArrow);
pub const ImGuiTreeNodeFlags_Leaf = @enumToInt(enum_unnamed_8.ImGuiTreeNodeFlags_Leaf);
pub const ImGuiTreeNodeFlags_Bullet = @enumToInt(enum_unnamed_8.ImGuiTreeNodeFlags_Bullet);
pub const ImGuiTreeNodeFlags_FramePadding = @enumToInt(enum_unnamed_8.ImGuiTreeNodeFlags_FramePadding);
pub const ImGuiTreeNodeFlags_SpanAvailWidth = @enumToInt(enum_unnamed_8.ImGuiTreeNodeFlags_SpanAvailWidth);
pub const ImGuiTreeNodeFlags_SpanFullWidth = @enumToInt(enum_unnamed_8.ImGuiTreeNodeFlags_SpanFullWidth);
pub const ImGuiTreeNodeFlags_NavLeftJumpsBackHere = @enumToInt(enum_unnamed_8.ImGuiTreeNodeFlags_NavLeftJumpsBackHere);
pub const ImGuiTreeNodeFlags_CollapsingHeader = @enumToInt(enum_unnamed_8.ImGuiTreeNodeFlags_CollapsingHeader);
...
pub const ImGuiTreeNodeFlags_ = enum_unnamed_8;
pub const ImGuiPopupFlags_None = @enumToInt(enum_unnamed_9.ImGuiPopupFlags_None);
pub const ImGuiPopupFlags_MouseButtonLeft = @enumToInt(enum_unnamed_9.ImGuiPopupFlags_MouseButtonLeft);
pub const ImGuiPopupFlags_MouseButtonRight = @enumToInt(enum_unnamed_9.ImGuiPopupFlags_MouseButtonRight);
pub const ImGuiPopupFlags_MouseButtonMiddle = @enumToInt(enum_unnamed_9.ImGuiPopupFlags_MouseButtonMiddle);
pub const ImGuiPopupFlags_MouseButtonMask_ = @enumToInt(enum_unnamed_9.ImGuiPopupFlags_MouseButtonMask_);
pub const ImGuiPopupFlags_MouseButtonDefault_ = @enumToInt(enum_unnamed_9.ImGuiPopupFlags_MouseButtonDefault_);
pub const ImGuiPopupFlags_NoOpenOverExistingPopup = @enumToInt(enum_unnamed_9.ImGuiPopupFlags_NoOpenOverExistingPopup);
pub const ImGuiPopupFlags_NoOpenOverItems = @enumToInt(enum_unnamed_9.ImGuiPopupFlags_NoOpenOverItems);
pub const ImGuiPopupFlags_AnyPopupId = @enumToInt(enum_unnamed_9.ImGuiPopupFlags_AnyPopupId);
pub const ImGuiPopupFlags_AnyPopupLevel = @enumToInt(enum_unnamed_9.ImGuiPopupFlags_AnyPopupLevel);
pub const ImGuiPopupFlags_AnyPopup = @enumToInt(enum_unnamed_9.ImGuiPopupFlags_AnyPopup);
...
pub const ImGuiPopupFlags_ = enum_unnamed_9;
pub const ImGuiSelectableFlags_None = @enumToInt(enum_unnamed_10.ImGuiSelectableFlags_None);
pub const ImGuiSelectableFlags_DontClosePopups = @enumToInt(enum_unnamed_10.ImGuiSelectableFlags_DontClosePopups);
pub const ImGuiSelectableFlags_SpanAllColumns = @enumToInt(enum_unnamed_10.ImGuiSelectableFlags_SpanAllColumns);
pub const ImGuiSelectableFlags_AllowDoubleClick = @enumToInt(enum_unnamed_10.ImGuiSelectableFlags_AllowDoubleClick);
pub const ImGuiSelectableFlags_Disabled = @enumToInt(enum_unnamed_10.ImGuiSelectableFlags_Disabled);
pub const ImGuiSelectableFlags_AllowItemOverlap = @enumToInt(enum_unnamed_10.ImGuiSelectableFlags_AllowItemOverlap);
...
pub const ImGuiSelectableFlags_ = enum_unnamed_10;
pub const ImGuiComboFlags_None = @enumToInt(enum_unnamed_11.ImGuiComboFlags_None);
pub const ImGuiComboFlags_PopupAlignLeft = @enumToInt(enum_unnamed_11.ImGuiComboFlags_PopupAlignLeft);
pub const ImGuiComboFlags_HeightSmall = @enumToInt(enum_unnamed_11.ImGuiComboFlags_HeightSmall);
pub const ImGuiComboFlags_HeightRegular = @enumToInt(enum_unnamed_11.ImGuiComboFlags_HeightRegular);
pub const ImGuiComboFlags_HeightLarge = @enumToInt(enum_unnamed_11.ImGuiComboFlags_HeightLarge);
pub const ImGuiComboFlags_HeightLargest = @enumToInt(enum_unnamed_11.ImGuiComboFlags_HeightLargest);
pub const ImGuiComboFlags_NoArrowButton = @enumToInt(enum_unnamed_11.ImGuiComboFlags_NoArrowButton);
pub const ImGuiComboFlags_NoPreview = @enumToInt(enum_unnamed_11.ImGuiComboFlags_NoPreview);
pub const ImGuiComboFlags_HeightMask_ = @enumToInt(enum_unnamed_11.ImGuiComboFlags_HeightMask_);
...
pub const ImGuiComboFlags_ = enum_unnamed_11;
pub const ImGuiTabBarFlags_None = @enumToInt(enum_unnamed_12.ImGuiTabBarFlags_None);
pub const ImGuiTabBarFlags_Reorderable = @enumToInt(enum_unnamed_12.ImGuiTabBarFlags_Reorderable);
pub const ImGuiTabBarFlags_AutoSelectNewTabs = @enumToInt(enum_unnamed_12.ImGuiTabBarFlags_AutoSelectNewTabs);
pub const ImGuiTabBarFlags_TabListPopupButton = @enumToInt(enum_unnamed_12.ImGuiTabBarFlags_TabListPopupButton);
pub const ImGuiTabBarFlags_NoCloseWithMiddleMouseButton = @enumToInt(enum_unnamed_12.ImGuiTabBarFlags_NoCloseWithMiddleMouseButton);
pub const ImGuiTabBarFlags_NoTabListScrollingButtons = @enumToInt(enum_unnamed_12.ImGuiTabBarFlags_NoTabListScrollingButtons);
pub const ImGuiTabBarFlags_NoTooltip = @enumToInt(enum_unnamed_12.ImGuiTabBarFlags_NoTooltip);
pub const ImGuiTabBarFlags_FittingPolicyResizeDown = @enumToInt(enum_unnamed_12.ImGuiTabBarFlags_FittingPolicyResizeDown);
pub const ImGuiTabBarFlags_FittingPolicyScroll = @enumToInt(enum_unnamed_12.ImGuiTabBarFlags_FittingPolicyScroll);
pub const ImGuiTabBarFlags_FittingPolicyMask_ = @enumToInt(enum_unnamed_12.ImGuiTabBarFlags_FittingPolicyMask_);
pub const ImGuiTabBarFlags_FittingPolicyDefault_ = @enumToInt(enum_unnamed_12.ImGuiTabBarFlags_FittingPolicyDefault_);
...
pub const ImGuiTabBarFlags_ = enum_unnamed_12;
pub const ImGuiTabItemFlags_None = @enumToInt(enum_unnamed_13.ImGuiTabItemFlags_None);
pub const ImGuiTabItemFlags_UnsavedDocument = @enumToInt(enum_unnamed_13.ImGuiTabItemFlags_UnsavedDocument);
pub const ImGuiTabItemFlags_SetSelected = @enumToInt(enum_unnamed_13.ImGuiTabItemFlags_SetSelected);
pub const ImGuiTabItemFlags_NoCloseWithMiddleMouseButton = @enumToInt(enum_unnamed_13.ImGuiTabItemFlags_NoCloseWithMiddleMouseButton);
pub const ImGuiTabItemFlags_NoPushId = @enumToInt(enum_unnamed_13.ImGuiTabItemFlags_NoPushId);
pub const ImGuiTabItemFlags_NoTooltip = @enumToInt(enum_unnamed_13.ImGuiTabItemFlags_NoTooltip);
pub const ImGuiTabItemFlags_NoReorder = @enumToInt(enum_unnamed_13.ImGuiTabItemFlags_NoReorder);
pub const ImGuiTabItemFlags_Leading = @enumToInt(enum_unnamed_13.ImGuiTabItemFlags_Leading);
pub const ImGuiTabItemFlags_Trailing = @enumToInt(enum_unnamed_13.ImGuiTabItemFlags_Trailing);
...
pub const ImGuiTabItemFlags_ = enum_unnamed_13;
pub const ImGuiFocusedFlags_None = @enumToInt(enum_unnamed_14.ImGuiFocusedFlags_None);
pub const ImGuiFocusedFlags_ChildWindows = @enumToInt(enum_unnamed_14.ImGuiFocusedFlags_ChildWindows);
pub const ImGuiFocusedFlags_RootWindow = @enumToInt(enum_unnamed_14.ImGuiFocusedFlags_RootWindow);
pub const ImGuiFocusedFlags_AnyWindow = @enumToInt(enum_unnamed_14.ImGuiFocusedFlags_AnyWindow);
pub const ImGuiFocusedFlags_RootAndChildWindows = @enumToInt(enum_unnamed_14.ImGuiFocusedFlags_RootAndChildWindows);
...
pub const ImGuiFocusedFlags_ = enum_unnamed_14;
pub const ImGuiHoveredFlags_None = @enumToInt(enum_unnamed_15.ImGuiHoveredFlags_None);
pub const ImGuiHoveredFlags_ChildWindows = @enumToInt(enum_unnamed_15.ImGuiHoveredFlags_ChildWindows);
pub const ImGuiHoveredFlags_RootWindow = @enumToInt(enum_unnamed_15.ImGuiHoveredFlags_RootWindow);
pub const ImGuiHoveredFlags_AnyWindow = @enumToInt(enum_unnamed_15.ImGuiHoveredFlags_AnyWindow);
pub const ImGuiHoveredFlags_AllowWhenBlockedByPopup = @enumToInt(enum_unnamed_15.ImGuiHoveredFlags_AllowWhenBlockedByPopup);
pub const ImGuiHoveredFlags_AllowWhenBlockedByActiveItem = @enumToInt(enum_unnamed_15.ImGuiHoveredFlags_AllowWhenBlockedByActiveItem);
pub const ImGuiHoveredFlags_AllowWhenOverlapped = @enumToInt(enum_unnamed_15.ImGuiHoveredFlags_AllowWhenOverlapped);
pub const ImGuiHoveredFlags_AllowWhenDisabled = @enumToInt(enum_unnamed_15.ImGuiHoveredFlags_AllowWhenDisabled);
pub const ImGuiHoveredFlags_RectOnly = @enumToInt(enum_unnamed_15.ImGuiHoveredFlags_RectOnly);
pub const ImGuiHoveredFlags_RootAndChildWindows = @enumToInt(enum_unnamed_15.ImGuiHoveredFlags_RootAndChildWindows);
...
pub const ImGuiHoveredFlags_ = enum_unnamed_15;
pub const ImGuiDragDropFlags_None = @enumToInt(enum_unnamed_16.ImGuiDragDropFlags_None);
pub const ImGuiDragDropFlags_SourceNoPreviewTooltip = @enumToInt(enum_unnamed_16.ImGuiDragDropFlags_SourceNoPreviewTooltip);
pub const ImGuiDragDropFlags_SourceNoDisableHover = @enumToInt(enum_unnamed_16.ImGuiDragDropFlags_SourceNoDisableHover);
pub const ImGuiDragDropFlags_SourceNoHoldToOpenOthers = @enumToInt(enum_unnamed_16.ImGuiDragDropFlags_SourceNoHoldToOpenOthers);
pub const ImGuiDragDropFlags_SourceAllowNullID = @enumToInt(enum_unnamed_16.ImGuiDragDropFlags_SourceAllowNullID);
pub const ImGuiDragDropFlags_SourceExtern = @enumToInt(enum_unnamed_16.ImGuiDragDropFlags_SourceExtern);
pub const ImGuiDragDropFlags_SourceAutoExpirePayload = @enumToInt(enum_unnamed_16.ImGuiDragDropFlags_SourceAutoExpirePayload);
pub const ImGuiDragDropFlags_AcceptBeforeDelivery = @enumToInt(enum_unnamed_16.ImGuiDragDropFlags_AcceptBeforeDelivery);
pub const ImGuiDragDropFlags_AcceptNoDrawDefaultRect = @enumToInt(enum_unnamed_16.ImGuiDragDropFlags_AcceptNoDrawDefaultRect);
pub const ImGuiDragDropFlags_AcceptNoPreviewTooltip = @enumToInt(enum_unnamed_16.ImGuiDragDropFlags_AcceptNoPreviewTooltip);
pub const ImGuiDragDropFlags_AcceptPeekOnly = @enumToInt(enum_unnamed_16.ImGuiDragDropFlags_AcceptPeekOnly);
...
pub const ImGuiDragDropFlags_ = enum_unnamed_16;
pub const ImGuiDataType_S8 = @enumToInt(enum_unnamed_17.ImGuiDataType_S8);
pub const ImGuiDataType_U8 = @enumToInt(enum_unnamed_17.ImGuiDataType_U8);
pub const ImGuiDataType_S16 = @enumToInt(enum_unnamed_17.ImGuiDataType_S16);
pub const ImGuiDataType_U16 = @enumToInt(enum_unnamed_17.ImGuiDataType_U16);
pub const ImGuiDataType_S32 = @enumToInt(enum_unnamed_17.ImGuiDataType_S32);
pub const ImGuiDataType_U32 = @enumToInt(enum_unnamed_17.ImGuiDataType_U32);
pub const ImGuiDataType_S64 = @enumToInt(enum_unnamed_17.ImGuiDataType_S64);
pub const ImGuiDataType_U64 = @enumToInt(enum_unnamed_17.ImGuiDataType_U64);
pub const ImGuiDataType_Float = @enumToInt(enum_unnamed_17.ImGuiDataType_Float);
pub const ImGuiDataType_Double = @enumToInt(enum_unnamed_17.ImGuiDataType_Double);
pub const ImGuiDataType_COUNT = @enumToInt(enum_unnamed_17.ImGuiDataType_COUNT);
...
pub const ImGuiDataType_ = enum_unnamed_17;
pub const ImGuiDir_None = @enumToInt(enum_unnamed_18.ImGuiDir_None);
pub const ImGuiDir_Left = @enumToInt(enum_unnamed_18.ImGuiDir_Left);
pub const ImGuiDir_Right = @enumToInt(enum_unnamed_18.ImGuiDir_Right);
pub const ImGuiDir_Up = @enumToInt(enum_unnamed_18.ImGuiDir_Up);
pub const ImGuiDir_Down = @enumToInt(enum_unnamed_18.ImGuiDir_Down);
pub const ImGuiDir_COUNT = @enumToInt(enum_unnamed_18.ImGuiDir_COUNT);
...
pub const ImGuiDir_ = enum_unnamed_18;
pub const ImGuiKey_Tab = @enumToInt(enum_unnamed_19.ImGuiKey_Tab);
pub const ImGuiKey_LeftArrow = @enumToInt(enum_unnamed_19.ImGuiKey_LeftArrow);
pub const ImGuiKey_RightArrow = @enumToInt(enum_unnamed_19.ImGuiKey_RightArrow);
pub const ImGuiKey_UpArrow = @enumToInt(enum_unnamed_19.ImGuiKey_UpArrow);
pub const ImGuiKey_DownArrow = @enumToInt(enum_unnamed_19.ImGuiKey_DownArrow);
pub const ImGuiKey_PageUp = @enumToInt(enum_unnamed_19.ImGuiKey_PageUp);
pub const ImGuiKey_PageDown = @enumToInt(enum_unnamed_19.ImGuiKey_PageDown);
pub const ImGuiKey_Home = @enumToInt(enum_unnamed_19.ImGuiKey_Home);
pub const ImGuiKey_End = @enumToInt(enum_unnamed_19.ImGuiKey_End);
pub const ImGuiKey_Insert = @enumToInt(enum_unnamed_19.ImGuiKey_Insert);
pub const ImGuiKey_Delete = @enumToInt(enum_unnamed_19.ImGuiKey_Delete);
pub const ImGuiKey_Backspace = @enumToInt(enum_unnamed_19.ImGuiKey_Backspace);
pub const ImGuiKey_Space = @enumToInt(enum_unnamed_19.ImGuiKey_Space);
pub const ImGuiKey_Enter = @enumToInt(enum_unnamed_19.ImGuiKey_Enter);
pub const ImGuiKey_Escape = @enumToInt(enum_unnamed_19.ImGuiKey_Escape);
pub const ImGuiKey_KeyPadEnter = @enumToInt(enum_unnamed_19.ImGuiKey_KeyPadEnter);
pub const ImGuiKey_A = @enumToInt(enum_unnamed_19.ImGuiKey_A);
pub const ImGuiKey_C = @enumToInt(enum_unnamed_19.ImGuiKey_C);
pub const ImGuiKey_V = @enumToInt(enum_unnamed_19.ImGuiKey_V);
pub const ImGuiKey_X = @enumToInt(enum_unnamed_19.ImGuiKey_X);
pub const ImGuiKey_Y = @enumToInt(enum_unnamed_19.ImGuiKey_Y);
pub const ImGuiKey_Z = @enumToInt(enum_unnamed_19.ImGuiKey_Z);
pub const ImGuiKey_COUNT = @enumToInt(enum_unnamed_19.ImGuiKey_COUNT);
...
pub const ImGuiKey_ = enum_unnamed_19;
pub const ImGuiKeyModFlags_None = @enumToInt(enum_unnamed_20.ImGuiKeyModFlags_None);
pub const ImGuiKeyModFlags_Ctrl = @enumToInt(enum_unnamed_20.ImGuiKeyModFlags_Ctrl);
pub const ImGuiKeyModFlags_Shift = @enumToInt(enum_unnamed_20.ImGuiKeyModFlags_Shift);
pub const ImGuiKeyModFlags_Alt = @enumToInt(enum_unnamed_20.ImGuiKeyModFlags_Alt);
pub const ImGuiKeyModFlags_Super = @enumToInt(enum_unnamed_20.ImGuiKeyModFlags_Super);
...
pub const ImGuiKeyModFlags_ = enum_unnamed_20;
pub const ImGuiNavInput_Activate = @enumToInt(enum_unnamed_21.ImGuiNavInput_Activate);
pub const ImGuiNavInput_Cancel = @enumToInt(enum_unnamed_21.ImGuiNavInput_Cancel);
pub const ImGuiNavInput_Input = @enumToInt(enum_unnamed_21.ImGuiNavInput_Input);
pub const ImGuiNavInput_Menu = @enumToInt(enum_unnamed_21.ImGuiNavInput_Menu);
pub const ImGuiNavInput_DpadLeft = @enumToInt(enum_unnamed_21.ImGuiNavInput_DpadLeft);
pub const ImGuiNavInput_DpadRight = @enumToInt(enum_unnamed_21.ImGuiNavInput_DpadRight);
pub const ImGuiNavInput_DpadUp = @enumToInt(enum_unnamed_21.ImGuiNavInput_DpadUp);
pub const ImGuiNavInput_DpadDown = @enumToInt(enum_unnamed_21.ImGuiNavInput_DpadDown);
pub const ImGuiNavInput_LStickLeft = @enumToInt(enum_unnamed_21.ImGuiNavInput_LStickLeft);
pub const ImGuiNavInput_LStickRight = @enumToInt(enum_unnamed_21.ImGuiNavInput_LStickRight);
pub const ImGuiNavInput_LStickUp = @enumToInt(enum_unnamed_21.ImGuiNavInput_LStickUp);
pub const ImGuiNavInput_LStickDown = @enumToInt(enum_unnamed_21.ImGuiNavInput_LStickDown);
pub const ImGuiNavInput_FocusPrev = @enumToInt(enum_unnamed_21.ImGuiNavInput_FocusPrev);
pub const ImGuiNavInput_FocusNext = @enumToInt(enum_unnamed_21.ImGuiNavInput_FocusNext);
pub const ImGuiNavInput_TweakSlow = @enumToInt(enum_unnamed_21.ImGuiNavInput_TweakSlow);
pub const ImGuiNavInput_TweakFast = @enumToInt(enum_unnamed_21.ImGuiNavInput_TweakFast);
pub const ImGuiNavInput_KeyMenu_ = @enumToInt(enum_unnamed_21.ImGuiNavInput_KeyMenu_);
pub const ImGuiNavInput_KeyLeft_ = @enumToInt(enum_unnamed_21.ImGuiNavInput_KeyLeft_);
pub const ImGuiNavInput_KeyRight_ = @enumToInt(enum_unnamed_21.ImGuiNavInput_KeyRight_);
pub const ImGuiNavInput_KeyUp_ = @enumToInt(enum_unnamed_21.ImGuiNavInput_KeyUp_);
pub const ImGuiNavInput_KeyDown_ = @enumToInt(enum_unnamed_21.ImGuiNavInput_KeyDown_);
pub const ImGuiNavInput_COUNT = @enumToInt(enum_unnamed_21.ImGuiNavInput_COUNT);
pub const ImGuiNavInput_InternalStart_ = @enumToInt(enum_unnamed_21.ImGuiNavInput_InternalStart_);
...
pub const ImGuiNavInput_ = enum_unnamed_21;
pub const ImGuiConfigFlags_None = @enumToInt(enum_unnamed_22.ImGuiConfigFlags_None);
pub const ImGuiConfigFlags_NavEnableKeyboard = @enumToInt(enum_unnamed_22.ImGuiConfigFlags_NavEnableKeyboard);
pub const ImGuiConfigFlags_NavEnableGamepad = @enumToInt(enum_unnamed_22.ImGuiConfigFlags_NavEnableGamepad);
pub const ImGuiConfigFlags_NavEnableSetMousePos = @enumToInt(enum_unnamed_22.ImGuiConfigFlags_NavEnableSetMousePos);
pub const ImGuiConfigFlags_NavNoCaptureKeyboard = @enumToInt(enum_unnamed_22.ImGuiConfigFlags_NavNoCaptureKeyboard);
pub const ImGuiConfigFlags_NoMouse = @enumToInt(enum_unnamed_22.ImGuiConfigFlags_NoMouse);
pub const ImGuiConfigFlags_NoMouseCursorChange = @enumToInt(enum_unnamed_22.ImGuiConfigFlags_NoMouseCursorChange);
pub const ImGuiConfigFlags_IsSRGB = @enumToInt(enum_unnamed_22.ImGuiConfigFlags_IsSRGB);
pub const ImGuiConfigFlags_IsTouchScreen = @enumToInt(enum_unnamed_22.ImGuiConfigFlags_IsTouchScreen);
...
pub const ImGuiConfigFlags_ = enum_unnamed_22;
pub const ImGuiBackendFlags_None = @enumToInt(enum_unnamed_23.ImGuiBackendFlags_None);
pub const ImGuiBackendFlags_HasGamepad = @enumToInt(enum_unnamed_23.ImGuiBackendFlags_HasGamepad);
pub const ImGuiBackendFlags_HasMouseCursors = @enumToInt(enum_unnamed_23.ImGuiBackendFlags_HasMouseCursors);
pub const ImGuiBackendFlags_HasSetMousePos = @enumToInt(enum_unnamed_23.ImGuiBackendFlags_HasSetMousePos);
pub const ImGuiBackendFlags_RendererHasVtxOffset = @enumToInt(enum_unnamed_23.ImGuiBackendFlags_RendererHasVtxOffset);
...
pub const ImGuiBackendFlags_ = enum_unnamed_23;
pub const ImGuiCol_Text = @enumToInt(enum_unnamed_24.ImGuiCol_Text);
pub const ImGuiCol_TextDisabled = @enumToInt(enum_unnamed_24.ImGuiCol_TextDisabled);
pub const ImGuiCol_WindowBg = @enumToInt(enum_unnamed_24.ImGuiCol_WindowBg);
pub const ImGuiCol_ChildBg = @enumToInt(enum_unnamed_24.ImGuiCol_ChildBg);
pub const ImGuiCol_PopupBg = @enumToInt(enum_unnamed_24.ImGuiCol_PopupBg);
pub const ImGuiCol_Border = @enumToInt(enum_unnamed_24.ImGuiCol_Border);
pub const ImGuiCol_BorderShadow = @enumToInt(enum_unnamed_24.ImGuiCol_BorderShadow);
pub const ImGuiCol_FrameBg = @enumToInt(enum_unnamed_24.ImGuiCol_FrameBg);
pub const ImGuiCol_FrameBgHovered = @enumToInt(enum_unnamed_24.ImGuiCol_FrameBgHovered);
pub const ImGuiCol_FrameBgActive = @enumToInt(enum_unnamed_24.ImGuiCol_FrameBgActive);
pub const ImGuiCol_TitleBg = @enumToInt(enum_unnamed_24.ImGuiCol_TitleBg);
pub const ImGuiCol_TitleBgActive = @enumToInt(enum_unnamed_24.ImGuiCol_TitleBgActive);
pub const ImGuiCol_TitleBgCollapsed = @enumToInt(enum_unnamed_24.ImGuiCol_TitleBgCollapsed);
pub const ImGuiCol_MenuBarBg = @enumToInt(enum_unnamed_24.ImGuiCol_MenuBarBg);
pub const ImGuiCol_ScrollbarBg = @enumToInt(enum_unnamed_24.ImGuiCol_ScrollbarBg);
pub const ImGuiCol_ScrollbarGrab = @enumToInt(enum_unnamed_24.ImGuiCol_ScrollbarGrab);
pub const ImGuiCol_ScrollbarGrabHovered = @enumToInt(enum_unnamed_24.ImGuiCol_ScrollbarGrabHovered);
pub const ImGuiCol_ScrollbarGrabActive = @enumToInt(enum_unnamed_24.ImGuiCol_ScrollbarGrabActive);
pub const ImGuiCol_CheckMark = @enumToInt(enum_unnamed_24.ImGuiCol_CheckMark);
pub const ImGuiCol_SliderGrab = @enumToInt(enum_unnamed_24.ImGuiCol_SliderGrab);
pub const ImGuiCol_SliderGrabActive = @enumToInt(enum_unnamed_24.ImGuiCol_SliderGrabActive);
pub const ImGuiCol_Button = @enumToInt(enum_unnamed_24.ImGuiCol_Button);
pub const ImGuiCol_ButtonHovered = @enumToInt(enum_unnamed_24.ImGuiCol_ButtonHovered);
pub const ImGuiCol_ButtonActive = @enumToInt(enum_unnamed_24.ImGuiCol_ButtonActive);
pub const ImGuiCol_Header = @enumToInt(enum_unnamed_24.ImGuiCol_Header);
pub const ImGuiCol_HeaderHovered = @enumToInt(enum_unnamed_24.ImGuiCol_HeaderHovered);
pub const ImGuiCol_HeaderActive = @enumToInt(enum_unnamed_24.ImGuiCol_HeaderActive);
pub const ImGuiCol_Separator = @enumToInt(enum_unnamed_24.ImGuiCol_Separator);
pub const ImGuiCol_SeparatorHovered = @enumToInt(enum_unnamed_24.ImGuiCol_SeparatorHovered);
pub const ImGuiCol_SeparatorActive = @enumToInt(enum_unnamed_24.ImGuiCol_SeparatorActive);
pub const ImGuiCol_ResizeGrip = @enumToInt(enum_unnamed_24.ImGuiCol_ResizeGrip);
pub const ImGuiCol_ResizeGripHovered = @enumToInt(enum_unnamed_24.ImGuiCol_ResizeGripHovered);
pub const ImGuiCol_ResizeGripActive = @enumToInt(enum_unnamed_24.ImGuiCol_ResizeGripActive);
pub const ImGuiCol_Tab = @enumToInt(enum_unnamed_24.ImGuiCol_Tab);
pub const ImGuiCol_TabHovered = @enumToInt(enum_unnamed_24.ImGuiCol_TabHovered);
pub const ImGuiCol_TabActive = @enumToInt(enum_unnamed_24.ImGuiCol_TabActive);
pub const ImGuiCol_TabUnfocused = @enumToInt(enum_unnamed_24.ImGuiCol_TabUnfocused);
pub const ImGuiCol_TabUnfocusedActive = @enumToInt(enum_unnamed_24.ImGuiCol_TabUnfocusedActive);
pub const ImGuiCol_PlotLines = @enumToInt(enum_unnamed_24.ImGuiCol_PlotLines);
pub const ImGuiCol_PlotLinesHovered = @enumToInt(enum_unnamed_24.ImGuiCol_PlotLinesHovered);
pub const ImGuiCol_PlotHistogram = @enumToInt(enum_unnamed_24.ImGuiCol_PlotHistogram);
pub const ImGuiCol_PlotHistogramHovered = @enumToInt(enum_unnamed_24.ImGuiCol_PlotHistogramHovered);
pub const ImGuiCol_TextSelectedBg = @enumToInt(enum_unnamed_24.ImGuiCol_TextSelectedBg);
pub const ImGuiCol_DragDropTarget = @enumToInt(enum_unnamed_24.ImGuiCol_DragDropTarget);
pub const ImGuiCol_NavHighlight = @enumToInt(enum_unnamed_24.ImGuiCol_NavHighlight);
pub const ImGuiCol_NavWindowingHighlight = @enumToInt(enum_unnamed_24.ImGuiCol_NavWindowingHighlight);
pub const ImGuiCol_NavWindowingDimBg = @enumToInt(enum_unnamed_24.ImGuiCol_NavWindowingDimBg);
pub const ImGuiCol_ModalWindowDimBg = @enumToInt(enum_unnamed_24.ImGuiCol_ModalWindowDimBg);
pub const ImGuiCol_COUNT = @enumToInt(enum_unnamed_24.ImGuiCol_COUNT);
...
pub const ImGuiCol_ = enum_unnamed_24;
pub const ImGuiStyleVar_Alpha = @enumToInt(enum_unnamed_25.ImGuiStyleVar_Alpha);
pub const ImGuiStyleVar_WindowPadding = @enumToInt(enum_unnamed_25.ImGuiStyleVar_WindowPadding);
pub const ImGuiStyleVar_WindowRounding = @enumToInt(enum_unnamed_25.ImGuiStyleVar_WindowRounding);
pub const ImGuiStyleVar_WindowBorderSize = @enumToInt(enum_unnamed_25.ImGuiStyleVar_WindowBorderSize);
pub const ImGuiStyleVar_WindowMinSize = @enumToInt(enum_unnamed_25.ImGuiStyleVar_WindowMinSize);
pub const ImGuiStyleVar_WindowTitleAlign = @enumToInt(enum_unnamed_25.ImGuiStyleVar_WindowTitleAlign);
pub const ImGuiStyleVar_ChildRounding = @enumToInt(enum_unnamed_25.ImGuiStyleVar_ChildRounding);
pub const ImGuiStyleVar_ChildBorderSize = @enumToInt(enum_unnamed_25.ImGuiStyleVar_ChildBorderSize);
pub const ImGuiStyleVar_PopupRounding = @enumToInt(enum_unnamed_25.ImGuiStyleVar_PopupRounding);
pub const ImGuiStyleVar_PopupBorderSize = @enumToInt(enum_unnamed_25.ImGuiStyleVar_PopupBorderSize);
pub const ImGuiStyleVar_FramePadding = @enumToInt(enum_unnamed_25.ImGuiStyleVar_FramePadding);
pub const ImGuiStyleVar_FrameRounding = @enumToInt(enum_unnamed_25.ImGuiStyleVar_FrameRounding);
pub const ImGuiStyleVar_FrameBorderSize = @enumToInt(enum_unnamed_25.ImGuiStyleVar_FrameBorderSize);
pub const ImGuiStyleVar_ItemSpacing = @enumToInt(enum_unnamed_25.ImGuiStyleVar_ItemSpacing);
pub const ImGuiStyleVar_ItemInnerSpacing = @enumToInt(enum_unnamed_25.ImGuiStyleVar_ItemInnerSpacing);
pub const ImGuiStyleVar_IndentSpacing = @enumToInt(enum_unnamed_25.ImGuiStyleVar_IndentSpacing);
pub const ImGuiStyleVar_ScrollbarSize = @enumToInt(enum_unnamed_25.ImGuiStyleVar_ScrollbarSize);
pub const ImGuiStyleVar_ScrollbarRounding = @enumToInt(enum_unnamed_25.ImGuiStyleVar_ScrollbarRounding);
pub const ImGuiStyleVar_GrabMinSize = @enumToInt(enum_unnamed_25.ImGuiStyleVar_GrabMinSize);
pub const ImGuiStyleVar_GrabRounding = @enumToInt(enum_unnamed_25.ImGuiStyleVar_GrabRounding);
pub const ImGuiStyleVar_TabRounding = @enumToInt(enum_unnamed_25.ImGuiStyleVar_TabRounding);
pub const ImGuiStyleVar_ButtonTextAlign = @enumToInt(enum_unnamed_25.ImGuiStyleVar_ButtonTextAlign);
pub const ImGuiStyleVar_SelectableTextAlign = @enumToInt(enum_unnamed_25.ImGuiStyleVar_SelectableTextAlign);
pub const ImGuiStyleVar_COUNT = @enumToInt(enum_unnamed_25.ImGuiStyleVar_COUNT);
...
pub const ImGuiStyleVar_ = enum_unnamed_25;
pub const ImGuiButtonFlags_None = @enumToInt(enum_unnamed_26.ImGuiButtonFlags_None);
pub const ImGuiButtonFlags_MouseButtonLeft = @enumToInt(enum_unnamed_26.ImGuiButtonFlags_MouseButtonLeft);
pub const ImGuiButtonFlags_MouseButtonRight = @enumToInt(enum_unnamed_26.ImGuiButtonFlags_MouseButtonRight);
pub const ImGuiButtonFlags_MouseButtonMiddle = @enumToInt(enum_unnamed_26.ImGuiButtonFlags_MouseButtonMiddle);
pub const ImGuiButtonFlags_MouseButtonMask_ = @enumToInt(enum_unnamed_26.ImGuiButtonFlags_MouseButtonMask_);
pub const ImGuiButtonFlags_MouseButtonDefault_ = @enumToInt(enum_unnamed_26.ImGuiButtonFlags_MouseButtonDefault_);
...
pub const ImGuiButtonFlags_ = enum_unnamed_26;
pub const ImGuiColorEditFlags_None = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_None);
pub const ImGuiColorEditFlags_NoAlpha = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_NoAlpha);
pub const ImGuiColorEditFlags_NoPicker = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_NoPicker);
pub const ImGuiColorEditFlags_NoOptions = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_NoOptions);
pub const ImGuiColorEditFlags_NoSmallPreview = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_NoSmallPreview);
pub const ImGuiColorEditFlags_NoInputs = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_NoInputs);
pub const ImGuiColorEditFlags_NoTooltip = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_NoTooltip);
pub const ImGuiColorEditFlags_NoLabel = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_NoLabel);
pub const ImGuiColorEditFlags_NoSidePreview = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_NoSidePreview);
pub const ImGuiColorEditFlags_NoDragDrop = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_NoDragDrop);
pub const ImGuiColorEditFlags_NoBorder = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_NoBorder);
pub const ImGuiColorEditFlags_AlphaBar = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_AlphaBar);
pub const ImGuiColorEditFlags_AlphaPreview = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_AlphaPreview);
pub const ImGuiColorEditFlags_AlphaPreviewHalf = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_AlphaPreviewHalf);
pub const ImGuiColorEditFlags_HDR = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_HDR);
pub const ImGuiColorEditFlags_DisplayRGB = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_DisplayRGB);
pub const ImGuiColorEditFlags_DisplayHSV = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_DisplayHSV);
pub const ImGuiColorEditFlags_DisplayHex = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_DisplayHex);
pub const ImGuiColorEditFlags_Uint8 = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_Uint8);
pub const ImGuiColorEditFlags_Float = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_Float);
pub const ImGuiColorEditFlags_PickerHueBar = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_PickerHueBar);
pub const ImGuiColorEditFlags_PickerHueWheel = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_PickerHueWheel);
pub const ImGuiColorEditFlags_InputRGB = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_InputRGB);
pub const ImGuiColorEditFlags_InputHSV = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags_InputHSV);
pub const ImGuiColorEditFlags__OptionsDefault = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags__OptionsDefault);
pub const ImGuiColorEditFlags__DisplayMask = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags__DisplayMask);
pub const ImGuiColorEditFlags__DataTypeMask = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags__DataTypeMask);
pub const ImGuiColorEditFlags__PickerMask = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags__PickerMask);
pub const ImGuiColorEditFlags__InputMask = @enumToInt(enum_unnamed_27.ImGuiColorEditFlags__InputMask);
...
pub const ImGuiColorEditFlags_ = enum_unnamed_27;
pub const ImGuiSliderFlags_None = @enumToInt(enum_unnamed_28.ImGuiSliderFlags_None);
pub const ImGuiSliderFlags_AlwaysClamp = @enumToInt(enum_unnamed_28.ImGuiSliderFlags_AlwaysClamp);
pub const ImGuiSliderFlags_Logarithmic = @enumToInt(enum_unnamed_28.ImGuiSliderFlags_Logarithmic);
pub const ImGuiSliderFlags_NoRoundToFormat = @enumToInt(enum_unnamed_28.ImGuiSliderFlags_NoRoundToFormat);
pub const ImGuiSliderFlags_NoInput = @enumToInt(enum_unnamed_28.ImGuiSliderFlags_NoInput);
pub const ImGuiSliderFlags_InvalidMask_ = @enumToInt(enum_unnamed_28.ImGuiSliderFlags_InvalidMask_);
...
pub const ImGuiSliderFlags_ = enum_unnamed_28;
...
pub const ImGuiCond_None = @enumToInt(enum_unnamed_31.ImGuiCond_None);
...
pub const ImDrawListFlags_AntiAliasedLinesUseTex = @enumToInt(enum_unnamed_33.ImDrawListFlags_AntiAliasedLinesUseTex);
...
pub const ImFontAtlasFlags_NoBakedLines = @enumToInt(enum_unnamed_34.ImFontAtlasFlags_NoBakedLines);
...
pub const ImGuiTabBarFlags_DockNode = @enumToInt(enum_unnamed_60.ImGuiTabBarFlags_DockNode);
pub const ImGuiTabBarFlags_IsFocused = @enumToInt(enum_unnamed_60.ImGuiTabBarFlags_IsFocused);
pub const ImGuiTabBarFlags_SaveSettings = @enumToInt(enum_unnamed_60.ImGuiTabBarFlags_SaveSettings);
...
pub const ImGuiTabBarFlagsPrivate_ = enum_unnamed_60;
pub const ImGuiTabItemFlags_NoCloseButton = @enumToInt(enum_unnamed_61.ImGuiTabItemFlags_NoCloseButton);
pub const ImGuiTabItemFlags_Button = @enumToInt(enum_unnamed_61.ImGuiTabItemFlags_Button);
const enum_unnamed_61 = extern enum(c_int) {
    ImGuiTabItemFlags_NoCloseButton = 1048576,
    ImGuiTabItemFlags_Button = 2097152,
    _,
};
pub const ImGuiTabItemFlagsPrivate_ = enum_unnamed_61;
...
pub extern fn igDragFloat(label: [*]const u8, v: [*c]f32, v_speed: f32, v_min: f32, v_max: f32, format: [*c]const u8, flags: ImGuiSliderFlags) bool;
...
pub extern fn ImGuiWindow_ImGuiWindow(context: [*c]ImGuiContext, name: [*c]const u8) [*c]ImGuiWindow;
pub extern fn ImGuiWindow_destroy(self: [*c]ImGuiWindow) void;
pub extern fn ImGuiWindow_GetIDStr(self: [*c]ImGuiWindow, str: [*c]const u8, str_end: [*c]const u8) ImGuiID;
pub extern fn ImGuiWindow_GetIDPtr(self: [*c]ImGuiWindow, ptr: ?*const c_void) ImGuiID;
pub extern fn ImGuiWindow_GetIDInt(self: [*c]ImGuiWindow, n: c_int) ImGuiID;
pub extern fn ImGuiWindow_GetIDNoKeepAliveStr(self: [*c]ImGuiWindow, str: [*c]const u8, str_end: [*c]const u8) ImGuiID;
pub extern fn ImGuiWindow_GetIDNoKeepAlivePtr(self: [*c]ImGuiWindow, ptr: ?*const c_void) ImGuiID;
pub extern fn ImGuiWindow_GetIDNoKeepAliveInt(self: [*c]ImGuiWindow, n: c_int) ImGuiID;
pub extern fn ImGuiWindow_GetIDFromRectangle(self: [*c]ImGuiWindow, r_abs: ImRect) ImGuiID;
pub extern fn ImGuiWindow_Rect(pOut: [*c]ImRect, self: [*c]ImGuiWindow) void;
pub extern fn ImGuiWindow_CalcFontSize(self: [*c]ImGuiWindow) f32;
pub extern fn ImGuiWindow_TitleBarHeight(self: [*c]ImGuiWindow) f32;
pub extern fn ImGuiWindow_TitleBarRect(pOut: [*c]ImRect, self: [*c]ImGuiWindow) void;
pub extern fn ImGuiWindow_MenuBarHeight(self: [*c]ImGuiWindow) f32;
pub extern fn ImGuiWindow_MenuBarRect(pOut: [*c]ImRect, self: [*c]ImGuiWindow) void;
...
pub extern fn igGetCurrentWindowRead() [*c]ImGuiWindow;
pub extern fn igGetCurrentWindow() [*c]ImGuiWindow;
pub extern fn igFindWindowByID(id: ImGuiID) [*c]ImGuiWindow;
pub extern fn igFindWindowByName(name: [*c]const u8) [*c]ImGuiWindow;
pub extern fn igUpdateWindowParentAndRootLinks(window: [*c]ImGuiWindow, flags: ImGuiWindowFlags, parent_window: [*c]ImGuiWindow) void;
pub extern fn igCalcWindowExpectedSize(pOut: [*c]ImVec2, window: [*c]ImGuiWindow) void;
pub extern fn igIsWindowChildOf(window: [*c]ImGuiWindow, potential_parent: [*c]ImGuiWindow) bool;
pub extern fn igIsWindowNavFocusable(window: [*c]ImGuiWindow) bool;
pub extern fn igGetWindowAllowedExtentRect(pOut: [*c]ImRect, window: [*c]ImGuiWindow) void;
pub extern fn igSetWindowPosWindowPtr(window: [*c]ImGuiWindow, pos: ImVec2, cond: ImGuiCond) void;
pub extern fn igSetWindowSizeWindowPtr(window: [*c]ImGuiWindow, size: ImVec2, cond: ImGuiCond) void;
pub extern fn igSetWindowCollapsedWindowPtr(window: [*c]ImGuiWindow, collapsed: bool, cond: ImGuiCond) void;
pub extern fn igSetWindowHitTestHole(window: [*c]ImGuiWindow, pos: ImVec2, size: ImVec2) void;
pub extern fn igFocusWindow(window: [*c]ImGuiWindow) void;
pub extern fn igFocusTopMostWindowUnderOne(under_this_window: [*c]ImGuiWindow, ignore_window: [*c]ImGuiWindow) void;
pub extern fn igBringWindowToFocusFront(window: [*c]ImGuiWindow) void;
pub extern fn igBringWindowToDisplayFront(window: [*c]ImGuiWindow) void;
pub extern fn igBringWindowToDisplayBack(window: [*c]ImGuiWindow) void;
pub extern fn igSetCurrentFont(font: [*c]ImFont) void;
pub extern fn igGetDefaultFont() [*c]ImFont;
pub extern fn igGetForegroundDrawListWindowPtr(window: [*c]ImGuiWindow) [*c]ImDrawList;
...
pub extern fn igStartMouseMovingWindow(window: [*c]ImGuiWindow) void;
...
pub extern fn igMarkIniSettingsDirtyWindowPtr(window: [*c]ImGuiWindow) void;
...
pub extern fn igSetScrollXWindowPtr(window: [*c]ImGuiWindow, scroll_x: f32) void;
pub extern fn igSetScrollYWindowPtr(window: [*c]ImGuiWindow, scroll_y: f32) void;
pub extern fn igSetScrollFromPosXWindowPtr(window: [*c]ImGuiWindow, local_x: f32, center_x_ratio: f32) void;
pub extern fn igSetScrollFromPosYWindowPtr(window: [*c]ImGuiWindow, local_y: f32, center_y_ratio: f32) void;
pub extern fn igScrollToBringRectIntoView(pOut: [*c]ImVec2, window: [*c]ImGuiWindow, item_rect: ImRect) void;
...
pub extern fn igSetActiveID(id: ImGuiID, window: [*c]ImGuiWindow) void;
pub extern fn igSetFocusID(id: ImGuiID, window: [*c]ImGuiWindow) void;
...
pub extern fn igSetLastItemData(window: [*c]ImGuiWindow, item_id: ImGuiID, status_flags: ImGuiItemStatusFlags, item_rect: ImRect) void;
pub extern fn igFocusableItemRegister(window: [*c]ImGuiWindow, id: ImGuiID) bool;
pub extern fn igFocusableItemUnregister(window: [*c]ImGuiWindow) void;
...
pub extern fn igClosePopupsOverWindow(ref_window: [*c]ImGuiWindow, restore_focus_to_window_under_popup: bool) void;
...
pub extern fn igGetTopMostPopupModal() [*c]ImGuiWindow;
pub extern fn igFindBestWindowPosForPopup(pOut: [*c]ImVec2, window: [*c]ImGuiWindow) void;
...
pub extern fn igNavInitWindow(window: [*c]ImGuiWindow, force_reinit: bool) void;
...
pub extern fn igNavMoveRequestTryWrapping(window: [*c]ImGuiWindow, move_flags: ImGuiNavMoveFlags) void;
...
pub extern fn igSetWindowClipRectBeforeSetChannel(window: [*c]ImGuiWindow, clip_rect: ImRect) void;
...
pub extern fn igFindOrCreateColumns(window: [*c]ImGuiWindow, id: ImGuiID) [*c]ImGuiColumns;
...
pub extern fn igGetWindowScrollbarRect(pOut: [*c]ImRect, window: [*c]ImGuiWindow, axis: ImGuiAxis) void;
pub extern fn igGetWindowScrollbarID(window: [*c]ImGuiWindow, axis: ImGuiAxis) ImGuiID;
pub extern fn igGetWindowResizeID(window: [*c]ImGuiWindow, n: c_int) ImGuiID;
...
pub extern fn igGcCompactTransientWindowBuffers(window: [*c]ImGuiWindow) void;
pub extern fn igGcAwakeTransientWindowBuffers(window: [*c]ImGuiWindow) void;
